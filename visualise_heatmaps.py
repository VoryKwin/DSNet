...
def parse_args():
    parser = argparse.ArgumentParser(description='Evaluate DSNet')

    # Network
    parser.add_argument('--network', type=str, default=r"F:\GraspLab\BestResults\jacquard\jacquard-RGBD\new\epoch_04_iou_0.956",
                        help='Path to saved network to evaluate')

    # Dataset & Data & Training
    parser.add_argument('--dataset', type=str, default="jacquard", help='Dataset Name ("cornell" or "jacquard")')
    parser.add_argument('--dataset-path', type=str, default="F:\GraspLab\datasets\jacquard", help='Path to dataset')
...
if __name__ == '__main__':
    ...
    val_dataset = Dataset(args.dataset_path, start=0.98, end=0.98915,
    ...
    with torch.no_grad():
        ...
        for id, (x, y, didx, rot, zoom_factor) in enumerate(val_data):
            ...
            output_folder = r'F:\GraspLab\BestResults\jacquard-1'
